  ...
  return (
    ...
    flex flex-col items-center justify-center gap-4'>
      ...
      <motion.p 
        ...
        className='max-w-2xl mx-auto leading-8 font-Ovo'
      >I am a frontend developer from 12 District, Ho Chi Minh City. Currently 
        I am a senior student at FPT Polytechnic College majoring in Web Programming. 
      </motion.p>
      <div className='flex flex-col sm:flex-row items-center gap-4 mt-4'>
        <motion.a 
          ...
          href="#contact" 
          className='px-10 py-3 border rounded-full border-white bg-black text-white 
